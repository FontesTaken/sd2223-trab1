...
public class SoapFeedsWebService extends SoapWebService<FeedsException> implements FeedsService{
    ...
    final Feeds impl;
    SoapFeedsWebService(String domain, int serverId) {
	...
	@Override
	public List<Message> getMessagesFromRemote(String user, String origianlDomain, long time) throws FeedsException {
		return super.fromJavaResult(impl.getMessagesFromRemote(user, origianlDomain, time));
	}
}